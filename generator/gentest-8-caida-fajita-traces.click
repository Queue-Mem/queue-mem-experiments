...
//JiffieClock()
fdIN0 :: FromIPSummaryDump(/mnt/traces/caida-18/queuemem-summaries/fixed-bin.pcap-1, TIMES $replay_count, TIMING 0, TIMESTAMP 0, ZERO false, BURST 32, STOP true, FIELDS timestamp ip_src ip_dst sport dport ip_proto ip_len eth_type);
fdIN1 :: FromIPSummaryDump(/mnt/traces/caida-18/queuemem-summaries/fixed-bin.pcap-2, TIMES $replay_count, TIMING 0, TIMESTAMP 0, ZERO false, BURST 32, STOP true, FIELDS timestamp ip_src ip_dst sport dport ip_proto ip_len eth_type);
